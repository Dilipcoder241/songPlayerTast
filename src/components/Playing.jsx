...
function Playing() {
  ...
  return (
    <div className='md:w-2/3 md:h-[75vh] h-[25vh] w-[90vw] rounded-lg m-3 border-2 border-[#31304D] relative overflow-hidden'>
      ...
      <div className='absolute -bottom-[13vw] md:-bottom-[9.5vw] left-[50%] -translate-x-[50%]'>
        <video ref={videoRef} muted loop src="/wave.webm" className='w-[80vw] mix-blend-lighten rounded-3xl'></video>
      </div>
    </div>
  )
}
